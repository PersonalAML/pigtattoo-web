const MILESTONES = [
  { date: "2025-06-01", label: "2025", title: "Convocatoria" },
  { date: "2026-01-01", label: "1 de enero de 2026", title: "Inicio del Proyecto" },
  { date: "2027-04-30", label: "30 de abril de 2027", title: "Fin de Periodo 1" },
  { date: "2028-07-01", label: "2028 / inicio de 2029", title: "Pruebas finales" },
  { date: "2029-04-30", label: "30 de abril de 2029", title: "Fin de Proyecto" },
];
...
export function Timeline() {
  ...
  return (
    <div className="mt-10">
      ...
      <div className="relative hidden pb-2 lg:block" role="list" aria-label="Cronograma del proyecto">
        {/* Línea base */}
      ...
      <ol className="space-y-4 border-l-2 border-accent/40 pl-6 lg:hidden" aria-label="Cronograma del proyecto">
        {MILESTONES.map((m) => {
          const done = new Date(m.date).getTime() <= now;
          return (
